 ...
 */
class CExtensionCallDirectBench extends AbstractBench
{
    ...
    {
        return cosine_similarity_c_direct($params['small'][0], $params['small'][1]);
    }

    #[Bench\ParamProviders(['provideData'])]
    public function benchMiddleSize($params)
    {
        return cosine_similarity_c_direct($params['middle'][0], $params['middle'][1]);
    }

    #[Bench\ParamProviders(['provideData'])]
    public function benchBigSize($params)
    {
        return cosine_similarity_c_direct($params['big'][0], $params['big'][1]);
    }
}
